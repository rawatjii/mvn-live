...
cd /d "D:\sandeep\mvn-react\project\mvn-react-old-new-repository\public\assets\json-frame\aeroone-gurgaon1\Panther\Black Panther 10-01-2025\Black Panther 10-01-2025\Mobile"
