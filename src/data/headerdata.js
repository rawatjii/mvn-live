...
export const otherProjects = [
  { location: 'Gurugram', projects: [{ name: 'MVN Mall', link: 'https://mvnmall.com/', status: 'new Launch' }, { name: 'MVN AeroOne', link: '/aeroone-gurgaon', status: 'new Launch', target_blank: false }, { name: 'MVN Mall 1', link: '/mvn-mall-1', target_blank: false }] },
