...
const metaFields = [
  ...
  { name: "value", label: "Value", type: "text", col: 12, isLeft: true },
  { name: "symbol", label: "Extra Symbol", type: "text", col: 12, isLeft: true },
...
export default function OurInfrastructure(){
  ...
  const aboutsApi = generateApi("infrastructure");
  ...
  return (
    <CustomSection customClass="">
      ...
      <LeftArea>
        <MicroBox>
          <CustomTitle title="Our Infrastructure Form" />
          <CustomForm
            isBanner={false}
      ...
      <RightArea>
        <MicroBox>
          <CustomTitle title="Our Infrastructure Table" />
          <CustomTable
            columns={columns}
            data={paginatedData}
            onEdit={handleEdit} 
