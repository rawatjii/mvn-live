...
const formFields = 
  {
    ...
    visible: true,
    fields: [{label: "Platter",type: "select",col: 6, selectedVal:'select',  name: "platter_id", options:platter?.map((item,index)=>({value:item.id,label:item.name})),isRequired:true},
      { name: "meta_title", label: "Meta Title", Placeholder:"Enter Meta Title", type: "text", col: 6,isRequired:true },
      { name: "meta_keyword", label: "Meta Keyword", Placeholder:"Enter Meta Keyword", type: "text", col: 6,isRequired:true },
      { name: "meta_description", label: "Meta Description", Placeholder:"Enter Meta Description", type: "text", col: 6,isRequired:true },
      { name: "project_name", label: "Project Name", Placeholder:"Enter Project Name", type: "text", col: 6,isRequired:true },
