                ...
                <Form onSubmit={addSubmitHandler} className="mt_40">
                    <Row>
                        <Form.Group as={Col} md="4" className="mb_15 form-group">
                            ...
                            <Form.Control autoComplete="off" id="ivrNumber" ref={ivrRef} className="goldenBorder" type="text" placeholder="Enter IVR Number" />
                            {errors.heading && <div className="errMsg text-danger">{errors.heading}</div>}
                        </Form.Group>

                        <Form.Group as={Col} md="4" className="mb_15 form-group">
                            <Form.Label htmlFor="email">Email*</Form.Label>
                            <Form.Control autoComplete="off"  id="email" ref={emailRef} className="goldenBorder" type="text" placeholder="Enter Email" />
                        ...
                        <Form.Group as={Col} md="12" className="mb_15 form-group">
                            ...
                            <Form.Control autoComplete="off"  id="mapUrl" ref={mapRef} className="goldenBorder" type="text" placeholder="Enter map Url" />
