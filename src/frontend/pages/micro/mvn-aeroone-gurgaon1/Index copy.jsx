...
import peacockJson from '../../../assets/images/aero-gurgaon/Peacock/data.json'
const livingRoomFramesUrl = import.meta.glob('/frontend/assets/images/aero-gurgaon/living-room/desktop/*.webp', { eager: true });
const livingRoomFrames = Object.values(livingRoomFramesUrl).map((module) => module.default);
// import livingRoomFramesUrl from '../../../assets/images/aero-gurgaon/living-room/desktop/';
import livingRoomJson from '../../../assets/images/aero-gurgaon/living-room/data.json';
import partyDesktopJson from '../../../assets/images/aero-gurgaon/PartyVideo/Desktop/data.json';
import partyMobileJson from '../../../assets/images/aero-gurgaon/PartyVideo/Mobile/data.json';
import pantherMobileJson from '../../../assets/images/aero-gurgaon/Panther/mobile/data.json';
import pantherDesktopJson from '../../../assets/images/aero-gurgaon/Panther/Desktop/data.json';
...
import elevationImg2 from '../../../assets/images/aero-gurgaon/renders/elevation/1.webp';
import elevationImgSm2 from '../../../assets/images/aero-gurgaon/renders/elevation/1_sm.webp';
import elevationImg3 from '../../../assets/images/aero-gurgaon/renders/elevation/1.webp';
import elevationImgSm3 from '../../../assets/images/aero-gurgaon/renders/elevation/1_sm.webp';
...
export const data = {
  ...
  //   desc: "Glide your way through the floor-to-ceiling sliding doors, and step on to the sprawling deck with breathtaking vistas and an air of tranquility.",
  //   path:{
  //     mobilePath:livingRoomFrames,
  //     desktopPath:livingRoomFrames,
  //   },
  //   frameCounts:{
