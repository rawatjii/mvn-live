...
const Construction = ({ data }) => {
  ...
  const slides = constructionData?.map((image) => ({
  ...
  return (
    <div className="section renders1_section wrappper center pb-0 Landscape-section" id="constructio">
      <div
                  ...
                  <div className="img">
                    <div className="WaterMarkContainer undefined">
                      ...
                      <div className="Watermark_logo athens_logo">
                        <picture>
                          <source srcSet={`${BACKEND_IMAGE_URL}${images.sm_alternative_image}`} />
                          <img src={`${BACKEND_IMAGE_URL}${images.sm_image}`} alt={images.alt} />
                        </picture>
                      </div>
                    </div>
                    <div
