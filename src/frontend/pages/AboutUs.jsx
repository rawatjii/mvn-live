...
import MicroBannerStatic from "../components/MicroBanner/IndexStatic";
...
const AboutUs = () => {
  ...
  const breadcrumbs = {
    ...
    links: [{ name: "Home", link: "/" }, { name: "About Us" }],
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about MVN’s legacy as a trusted real estate company in India. Discover our vision, values, and commitment to delivering quality residential and commercial projects."
        ></meta>
        <link rel="canonical" href="https://www.mvn.in/about-us" />
      </Helmet>
      <Layout>
        <MicroBannerStatic bg={microBg} data={breadcrumbs} />
