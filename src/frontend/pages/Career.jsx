...
const RewardsImg = `${API_URL}images/career/rewards.png`;
const ligemvnImg = `${API_URL}images/career/lifeatmvn.webp`;
const BlankIMG = `${API_URL}images/career/bg.png`;
const headingIconImg = `${API_URL}images/icons/heading-icon-img.webp`;
const CareerImg = `${API_URL}images/career/career-img.jpg`;
            ...
            <Suspense fallback="loading">
              <div className="content_col position-relative page-header-main-heading">
                <Container>
                  ...
                  >
                    Our Human Resources team is dedicated to attracting,
                    nurturing, and retaining top talent, ensuring the right
                    individuals are in the right roles to drive the company
                    forward. We prioritize skills, passion, and commitment to
                      ...
                      <div className="content-half h-100">
                        <div>
                          ...
                          <p className="des_style1">
                            At MVN, we cultivate a culture of collaboration,
                            innovation, and inclusivity, where every
                            individual’s voice is valued and every contribution
                            matters. We believe in fostering a positive, dynamic
                            work environment that encourages personal and
                            professional growth.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="gd-inner h-100 d-grid align-items-center">
                          <div>
                            ...
                            <p className="des_style1">
                              ...
                              our people, providing opportunities for learning,
                              mentorship, and skill enhancement. Our focus is on
                              empowering employees to reach their fullest
                      ...
                      <div className="content-right-img">
                        <div className="gd-inner h-100 d-grid align-items-center">
                          <div>
                            ...
                            <p className="des_style1">
                              We celebrate achievements and milestones, ensuring
                              our employees’ hard work and dedication are
                              recognized and rewarded. Through tailored
                              incentives and acknowledgment, we motivate our
                    ...
                    <div className="half">
                      <div className="content-half h-100">
                        <div>
                          <h2>Life At MVN</h2>
                          <p className="des_style1">
                            Life at MVN is all about balance, collaboration, and
                            growth. We offer a supportive and vibrant workplace
                            where employees thrive, enjoy meaningful work, and
                            are encouraged to achieve both professional success
