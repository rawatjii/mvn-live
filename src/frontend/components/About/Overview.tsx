...
const Overview: React.FC = () => {
  ...
  const desRefs = useRef<HTMLParagraphElement[]>([]);
      ...
      >
        <div className="content_col position-relative page-header-main-heading">
          ...
          <Container>
            ...
            <p
              ref={(el) => el && (desRefs.current[0] = el)}
              className="des_style1 text-center"
            >
              At MVN, we are fired by an indomitable will to shape the future.
              We commenced our corporate journey in 1983 and have since evolved
              into a contemporary business entity with interests in education
              and real estate.
            </p>

            <p
              ref={(el) => el && (desRefs.current[1] = el)}
              className="des_style1 text-center"
            >
              Our first educational venture, Modern Vidya Niketan School was
              conceived in 1983. Today it is one of the most respected and
              acclaimed schools in the field. Several other institutions in the
              NCR region bear our name and are considered the ideal learning
              grounds for budding destinies. Not content to rest on our laurels,
              we are today forging ahead with strategic forays into urban
              infrastructure development, real estate, and hospitality. We have
              identified prime locations for each of our projects and are
              convinced that these areas would be crucial to our resurgence and
              growth.
            </p>
          </Container>
        </div>
