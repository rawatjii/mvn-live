  ...
  return(
    <div className="offers_section">
      <div className="single" role="link" tabIndex={0} style={{cursor:'pointer'}} onClick={()=>clickHandler(false)}>
        <video src={offer1} muted  className="img-fluid d-none d-md-block" playsInline autoPlay loop />
        <video src={offer1_sm} muted  className="img-fluid d-md-none" playsInline autoPlay loop />
      </div>
    </div>
  )
})
