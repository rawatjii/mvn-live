  ...
  return (
    ...
    <div className='row gy-3 d-flex justify-content-center'>
        ...
        <div className="col-md-12 col-xl-6 order-1 order-xl-2">
            ...
            <h2>Begin your Project Exploration <br className='d-none md:d-block'/> with us, your journey begins here. </h2>
            {white 
            ? <p className={`title mt-4`}>Call our Ultra <br/> Luxury Sales Specialist</p>
            : <p className={`detail_title mt-4`}>Call our Ultra <br/> Luxury Sales Specialist</p>
            }
